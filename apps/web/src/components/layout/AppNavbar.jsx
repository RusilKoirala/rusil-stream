      ...
      <div className="flex items-center justify-between px-4 md:px-12 py-5">
        <div className="flex items-center gap-10">
          ...
          <div className="hidden lg:flex items-center gap-7 text-sm">
            ...
            <Link href="/download" className="flex items-center gap-1.5 text-blue-400 hover:text-blue-300 font-semibold transition">
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-black/95 backdrop-blur border-t border-white/10">
          <div className="px-4 py-4 space-y-1">
            ...
            <Link href="/download" onClick={() => setMobileMenuOpen(false)} className="block px-4 py-3 text-blue-400 font-semibold rounded-lg hover:bg-blue-500/10 transition">⬇ Get App</Link>
          </div>
        </div>
      )}
    </nav>
